...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def process_request(self, request, spider):        
        ...
        request.headers['User-Agent'] = random_browser_header
...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def _scrapeops_fake_browser_headers_enabled(self):
        if self.scrapeops_api_key is None or self.scrapeops_api_key == '' or self._scrapeops_fake_browser_headers_enabled == False:
            self._scrapeops_fake_browser_headers_enabled = False
        else:
            self._scrapeops_fake_browser_headers_enabled = True
